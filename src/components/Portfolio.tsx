...
const projects = [
  {
    ...
    link: "https://www.seamlesstravel.co.za",
  },
  {
    title: "Sterring",
    client: "Streaming Platform",
    description: "A Netflix-style streaming platform for South African film, TV, and anime — browse local titles, watch trailers, and build a personal watchlist.",
    image: "https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=500&h=300&fit=crop",
    alt: "Sterring streaming platform screenshot",
    link: "https://sterring.netlify.app/",
  },
  {
    title: "Better Man Properties",
    client: "Property Development",
    description: "A corporate site for a property development and management company — showcasing their development pipeline, managed portfolio, and track record.",
    image: "https://images.unsplash.com/photo-1460317442991-0ec209397118?w=500&h=300&fit=crop",
    alt: "Better Man Properties website screenshot",
    link: "https://betterman-properties.netlify.app/",
  },
  {
    title: "FlowPro Plumbing",
    client: "Local Service Business",
    description: "A conversion-focused site for a 24/7 emergency plumbing service — service area, trust badges, and a one-tap call-to-book flow for urgent callouts.",
    image: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=500&h=300&fit=crop",
    alt: "FlowPro Plumbing website screenshot",
    link: "https://flowpro-plumbers.netlify.app/",
  },
];

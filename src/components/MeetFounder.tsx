  ...
  <section className="py-20 md:py-28 bg-background">
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-10">
      ...
      <div className="flex-shrink-0">
        <div className="w-40 h-40 rounded-full bg-surface flex items-center justify-center overflow-hidden ring-2 ring-primary/40 glow-sphere">
          <img
            ...
            alt="Founder Tshegofats Sekhotha"
      ...
      <div className="flex-1 text-center md:text-left">
        ...
        <h3 className="text-xl font-heading text-accent mb-2">Tshegofats Sekhotha</h3>
        ...
        <p className="text-muted max-w-xl mx-auto md:mx-0 leading-relaxed">
          Hi! I'm Tshegofats Sekhotha, a passionate web and software developer dedicated to helping businesses grow through technology. I work directly with every client to ensure your vision is brought to life with care, creativity, and technical excellence.
        </p>
      </div>
    </div>
  </section>

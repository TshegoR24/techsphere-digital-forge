const Privacy = () => {
  return (
    <div className="min-h-screen px-6 py-16 max-w-3xl mx-auto">
      ...
      <p className="text-primary/80 mb-4">
        TechSphere Solutions is the responsible party for purposes of the Protection of Personal Information Act, 2013 (POPIA). If you have questions about this policy or your rights, please contact us at <a className="text-primary underline" href="mailto:ts.techsphere@gmail.com">ts.techsphere@gmail.com</a>.
      </p>
      ...
      <p className="text-primary/80 mb-4">
        Under POPIA, you have the right to request access to, correction or deletion of your personal information, object to processing, and withdraw consent where processing is based on consent. You may also lodge a complaint with the Information Regulator. To exercise your rights, contact us at <a className="text-primary underline" href="mailto:ts.techsphere@gmail.com">ts.techsphere@gmail.com</a>.
      </p>
      ...
      <p className="text-primary/80 mb-4">
        If you have questions about this policy or our data practices, please contact us via the details on our <a className="text-primary underline" href="/#contact">Contact</a> section or email <a className="text-primary underline" href="mailto:ts.techsphere@gmail.com">ts.techsphere@gmail.com</a>.
      </p>

...
const Refund = () => {
  return (
    ...
    <div className="px-6 pt-32 pb-16 max-w-3xl mx-auto">
      <h1 className="text-3xl font-heading font-semibold text-text mb-6">Refund Policy</h1>
      ...
      <ol className="list-decimal pl-5 text-muted space-y-2">
        <li>Email <a className="text-accent underline" href="mailto:ts.techsphere@gmail.com">ts.techsphere@gmail.com</a> with your invoice number and reason.</li>
      ...
      <p className="text-muted mb-4">
        Questions? Contact our support team at <a className="text-accent underline" href="mailto:ts.techsphere@gmail.com">ts.techsphere@gmail.com</a>.
      </p>
